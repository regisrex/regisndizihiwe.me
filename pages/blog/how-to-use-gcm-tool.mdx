...
<BlogTitle releaseDate="11th October 2023" id="how-to-use-gcm-tool" title="The new version and usage of gcm, a cli too to make conventional git commit messages" readTime="5 min" description="Later this week I was walking around in Github, searching for rust codebases and seeing what can be built with rust..."/>
